...
exports.createCourse = async (req, res) => {
    try {
        ...
        // upaod image to cloudinary
        const thumbnailImage = await uploadImage(thumbnail, process.env.FOLDER_NAME, 1000, 1000);
        ...
        // add the new course to the courses array of the category
...
exports.getAllCourses = async (req, res) => {
    try {
        ...
        return res.status(200).json({
            success: true,
            message: "Data for all courses is found",
            data: allCourses,
        })
    } catch (error) {
        console.log(error);
...
exports.getCourseDetails = async (req, res) => {
    try {
        ...
        if (!CourseDetails) {
            return res.status(400).json({
                success: false,
                message: `Couldn't find coursewith the ${courseId}`,
            })
        }
