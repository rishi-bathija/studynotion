        ...
        <div className="min-h-[calc(100vh-3.5rem)] grid place-items-center">
            {loading ? (
                ...
                <div className='max-w-[500px] p-4 lg:p-8'>
                    ...
                    <p className='text-[1.125rem] leading-[1.625rem] my-4 text-richblack-100'>A verification code has been sent to your mail.Enter it below</p>
                    <form onSubmit={handleSubmit}>
                        <OTPInput
                            ...
                            renderInput={(props) => <input {...props} placeholder="-"
                                ...
                                className="w-[48px] lg:w-[60px] border-0 bg-richblack-800 rounded-[0.5rem] text-richblack-5 aspect-square text-center focus:border-0 focus:outline-2 focus:outline-yellow-50" />} containerStyle={{
